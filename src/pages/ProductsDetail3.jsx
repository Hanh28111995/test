...
import product_detail_1 from './../../public/assets/image/bg_img/product_detail_3.png'
import location_decor_img from './../../public/assets/image/bg_img/location-decor-img.png'
import one_bottle from './../../public/assets/image/product_img/Layer 1 1.png'
...
export default function ProductsDetail3() {
    const settings = {
        dots: false,
        infinite: true,
        speed: 500,
    ...
    return (
        <>
            < Head >
                <title>SON FOODS - Two Fish Sauce Bottles </title>
            </Head >
